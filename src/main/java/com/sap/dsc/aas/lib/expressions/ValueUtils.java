...
public class ValueUtils {
     ...
     *
     * @param t1 one argument type to an operator
     * @param t2 the other argument type
     ...
     * @param trim if true this returned string value is trimmed of whitespace using String.trim().
     *
    ...
    /**
     * Adds the two objects given. For numeric values this will add them numerically; for one of the
     * arguments being non-numeric this will catenate them as Strings.
     *
     * @param v1 First addend
     ...
     *
     * @param v1 Value to be subtracted from.
     * @param v2 Value to be subtracted from v1.
     *
     * @return v1 - v2
     */
     ...
     *
     * @param v1 First multiplicand
     * @param v2 Second multiplicand
     *
     * @return v1 * v2
     */
    ...
    /**
     * Returns a new Number object of an appropriate type to hold the given integer value. The type of
     * the returned object is consistent with the given type argument, which is a constant from the
     * NumericTypes interface.
     *
     * @param type the nominal numeric type of the result
    ...
    /**
     * Returns a new Number object of an appropriate type to hold the given real value. The type of the
     * returned object is always either Float or Double, and is only Float if the given type tag (a
     * constant from the NumericTypes interface) is FLOAT.
     *
     * @param type the nominal numeric type of the result
     ...
     * @param defaultValue value returned in the event that no conversion is possible to the given type
     *
     * @return converted value of the type given, or defaultValue if the value cannot be converted to
     *         the given type.
     */
